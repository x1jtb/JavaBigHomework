...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable() // 禁用 CSRF 保护
                ...
                .antMatchers("/api/auth/authority/admin","/api/auth/admin/**","/api/data/admin/**").hasAuthority("ADMIN") //访问该资源需要管理员身份
                .antMatchers("/api/auth/authority/user").hasAnyAuthority("ADMIN","USER") // 进入该资源需要用户或管理员身份
